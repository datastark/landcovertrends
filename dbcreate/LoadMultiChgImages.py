# File loadMultiChgImages.py
#
#   Take the Trends land cover multi-change images generated with Imagine
#   and add the file locations into the Trends geodatabase MultiChange
#   table.  In addition, extract relevant metadata from the filename
#   and enter into the multichange table along with the filename.
...
def splitTheFileName (fileName):
    ...
    #sample filename looks like: 'samp07_0426_multichange_change_60m.img'
    #For mosaic blocks, a sample name looks like
    #       'samp83_0388_mosaic_multichange_60m.img'
    #Also, may need to standardize sampleBlkID if this was missed
...
try:
    ...
    topPath = TrendsNames.multichangeFolders

    changeLoc = TrendsNames.dbLocation + "MultiChangeImage"
    ...
    for raster in allFiles:
        ...
        #Create a new row object for the table, and add attributes
